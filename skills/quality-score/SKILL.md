...
name: quality-score
description: >-
  Give an evidence-backed quality grade or humorous ticket for prose, UI/design,
  or code when explicitly requested. Also supports scoped audit and rewrite
  modes when selected by the user. Use
  writing-edit for ordinary prose edits and design-lead for general design review.
  Does not determine AI authorship.
license: MIT
metadata:
  author: howshannon
  version: "0.4.0"
...
Quality Score reviews three kinds of material: **prose**, **design**, and
**code**. It names observable problems and fixes them without treating style as
proof of AI authorship.

Follow the [local skill map](../design-lead/reference/skill-map.md). This is an optional graded-review specialist, not a mandatory final check on every design or draft. Preserve the design brief when reviewing UI, and do not run overlapping editors by default.
...
## Scoring for Grade and Ticket modes
...
In Grade and Ticket modes, report the score, letter grade, charge, evidence, penalty arithmetic,
