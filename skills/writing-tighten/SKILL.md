...
description: Make a quick, minimal cleanup of short prose by removing empty setup, repetition, and inflated wording while preserving meaning and voice. Use for a light wording pass; use writing-edit for longer or voice-sensitive editing. Does not score writing or determine AI authorship.
metadata:
...
A short editing pass, scoped by the [local skill map](../design-lead/reference/skill-map.md). Use one prose editor for a passage. Do not automatically follow this pass with another anti-slop skill.
...
For a substantial rewrite or sensitive voice work, use [writing-edit](../writing-edit/SKILL.md). For a requested numerical grade or humorous ticket, use [quality-score](../quality-score/SKILL.md). Do not add scores, explanations, or report files to an ordinary cleanup.
