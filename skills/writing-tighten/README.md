...
> Upstream archive. This collection uses the name **writing-tighten**. See the [current skill](SKILL.md) and [collection README](../../README.md) for maintained usage and installation instructions.
