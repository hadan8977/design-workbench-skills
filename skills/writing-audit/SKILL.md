---
name: writing-audit
description: Apply a detailed writing rulebook when explicitly requested for a contextual prose audit or rewrite, voice profile, protected-content review, or edit-in-place task. Supports detect-only mode. Use writing-edit for ordinary prose editing. Does not determine AI authorship.
license: MIT
metadata:
  version: "3.35.0"
...
Follow the [local skill map](../design-lead/reference/skill-map.md). This detailed
rulebook requires explicit selection on every host. For ordinary
draft editing use [writing-edit](../writing-edit/SKILL.md); do not stack both editors
or their reports by default.

## What this skill is and isn't

Evaluate observable writing choices in the source's genre, language, and voice.
A repeated pattern can justify an editorial suggestion; it does not establish
AI authorship. Treat every pattern as a candidate governed by the editing
contract below. Do not remove accurate technical language, meaningful
uncertainty, protected quotations, or intentional voice to satisfy a blacklist.
