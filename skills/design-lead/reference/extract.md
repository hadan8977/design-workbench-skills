...
**CRITICAL**: If no design system exists, do not create one yet. STOP and use the host's structured question tool when available; if unavailable, ask directly in chat to clarify what you cannot infer. Understand the preferred location and structure first.
