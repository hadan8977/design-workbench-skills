...
- **Suggested command**: Which command to use (prefer: $design-lead adapt, $design-lead animate, $design-lead audit, $design-lead bolder, $design-lead clarify, $design-lead colorize, $design-lead critique, $design-lead delight, $design-lead distill, $design-lead document, $design-lead harden, $design-lead layout, $design-lead onboard, $design-lead optimize, $design-lead overdrive, $design-lead polish, $design-lead quieter, $design-lead shape, $design-lead typeset)
...
**Rules**: Only recommend commands from: $design-lead adapt, $design-lead animate, $design-lead audit, $design-lead bolder, $design-lead clarify, $design-lead colorize, $design-lead critique, $design-lead delight, $design-lead distill, $design-lead document, $design-lead harden, $design-lead layout, $design-lead onboard, $design-lead optimize, $design-lead overdrive, $design-lead polish, $design-lead quieter, $design-lead shape, $design-lead typeset. Map findings to the most appropriate command. End with `$design-lead polish` as the final step if any fixes were recommended.

After presenting the summary, tell the user:

> You can ask me to run these one at a time, all at once, or in any order you prefer.
>
> Re-run `$design-lead audit` after fixes to see your score improve.
