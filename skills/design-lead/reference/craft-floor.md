...
Inspect these relationships in the requested scope. The brief determines the visual language; this reference checks whether that language is executed well. Use [design-purpose](../../design-purpose/SKILL.md) only when a choice needs the purpose test.
