...
The core workflow is host-neutral. Read [runtime notes](reference/runtime.md) when browser access, image generation, host adapters, or the optional upstream Impeccable engine are needed. Resolve scripts from this skill's directory and use the host's available capabilities.
