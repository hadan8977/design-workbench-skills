...
> Upstream archive. This collection uses the name **design-simplify**. See the [current skill](SKILL.md) and [collection README](../../README.md) for maintained usage and installation instructions.
